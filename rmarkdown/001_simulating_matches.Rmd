...
If the `play.game()` code is any good, then we'd expect these theoretical results to be consistent with tennis matches played in the real world. I've used Jeff Sackmann's fantastic repository of ATP match data to check.
